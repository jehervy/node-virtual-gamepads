...
uinput.input_id = restruct.int16lu('bustype')
					   .int16lu('vendor')
					   .int16lu('product')
					   .int16lu('version')
					   .pad(1012);

uinput.uinput_user_dev = restruct.string('name', uinput.UINPUT_MAX_NAME_SIZE )
...
uinput.timeval = restruct.int32ls('tv_sec').int32ls('tv_usec');


uinput.input_event = restruct.struct('time', uinput.timeval)
                                                  .int16lu('type')
                                                  .int16lu('code')
                                                  .int32ls('value');
